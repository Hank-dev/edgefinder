...
CORE_SOURCES = [
    {"key": "ted-norway", "name": "TED / Doffin Norway", "kind": "procurement", "region": "norway", "base_url": "https://api.ted.europa.eu", "quality": 0.95},
    {"key": "brreg", "name": "Brønnøysundregistrene", "kind": "registry", "region": "norway", "base_url": "https://data.brreg.no", "quality": 0.95},
    {"key": "nav-jobs", "name": "NAV Arbeidsplassen", "kind": "jobs", "region": "norway", "base_url": "https://arbeidsplassen.nav.no", "quality": 0.9},
    ...
    {"key": "eurlex", "name": "EUR-Lex updates", "kind": "regulation", "region": "europe", "base_url": "https://eur-lex.europa.eu", "quality": 0.95},
...
def build_collectors(settings: Settings) -> list[BaseCollector]:
    collectors: list[BaseCollector] = [
        ...
        FeedCollector(settings, key="eurlex", url="https://eur-lex.europa.eu/EN/display-feed.rss?rssId=164", region="europe", language="en"),
